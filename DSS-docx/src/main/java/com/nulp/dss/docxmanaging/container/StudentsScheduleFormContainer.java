...
public class StudentsScheduleFormContainer implements DataContainer {
	private static final String CREATING_TABLE_TAG_NAME = "schedule_table";
	private static final int COLLUMN_NUMBER = 6;
	private Map<String, String> tagsMap;
	private List<ArrayList<String>> table; 

	
	public StudentsScheduleFormContainer(Map<String, String> tagsMap,
